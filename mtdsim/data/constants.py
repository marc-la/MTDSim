...
SERVICE_COMPROMISED_THRESHOLD = 7  # Σ exploited impact cutoff (impact range [0, 10]) — inherited; see docs/implementation/mtdsim_spec.md NET-14 / C3.
...
ATTACKER_THRESHOLD = 10  # per-host attempt cap (give-up rule) — Brown 2023 §III-C(2), Table I; see docs/implementation/mtdsim_spec.md ATK-07.
...
# mtd name : (mean, std) — Zhang 2023, Table 3 (MTDSimTime thesis); see docs/implementation/mtdsim_spec.md MTD-14.
MTD_DURATION = {
