...
The handoffs in this folder execute the rulings from the 2026-08-11
...
**V5–V7 shipped** (skeleton 2026-08-12, grading-note re-aim 2026-08-13; the
register's V-trail annotation is the record) and **V3 commissions nothing** (use Tay's pretrained agent as-is; no retraining).
