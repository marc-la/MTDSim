...
> [`13_command-and-control`](../../notes/ch4_methods/tactic_profiles/13_command-and-control.md). C2's
...
axis) and [`09_credential-access`](../../notes/ch4_methods/tactic_profiles/09_credential-access.md)
