...
> follows**. Extracted for [`03_initial-access`](../../notes/ch4_methods/tactic_profiles/03_initial-access.md).
...
**Maps to:** [`03_initial-access`](../../notes/ch4_methods/tactic_profiles/03_initial-access.md) §4
...
zero-day-first) and [`02_resource-development`](../../notes/ch4_methods/tactic_profiles/02_resource-development.md)
