...
- The first instalment itself — its design, its per-conclusion verdicts, and the numbers behind every claim in the section above: [`../../implementation/pipeline/ogasp/weight_sensitivity_study.md`](../../implementation/pipeline/ogasp/weight_sensitivity_study.md).
...
- When the remaining three declared families are swept: the section on the first instalment extends rather than being rewritten, since it is worded as one part of a four-part discharge.
