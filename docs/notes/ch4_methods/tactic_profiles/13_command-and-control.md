...
custom protocols ([`alshamrani2019`](../../../sources/extractions/alshamrani2019.md) §II-D) [fetched]. Its
...
([`alshamrani2019`](../../../sources/extractions/alshamrani2019.md) §IV-A) [fetched]. A channel that lives
...
([`alshamrani2019`](../../../sources/extractions/alshamrani2019.md) §IV-B) [fetched]. So C2's dwell is
...
([`selmanaj2024`](../../../sources/extractions/selmanaj2024.md) Ch. 4). So an IP/topology shuffle **degrades
...
[`c2_beaconing`](../../../sources/extractions/c2_beaconing.md)), and a defender optimises a config sequence and
...
([substrate primer](../../../implementation/substrate_primer.md) §(e).1): here the substrate is *harsher* on
