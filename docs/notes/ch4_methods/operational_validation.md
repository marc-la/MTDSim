...
- If the sweep shows the conclusion is *not* robust to the declared durations, operational validation has failed for this model; the note is rewritten around the negative result (see [`../ch4_methods/evaluation_burden.md`](../ch4_methods/evaluation_burden.md)).
