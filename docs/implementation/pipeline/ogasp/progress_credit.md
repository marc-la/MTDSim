...
- **169 tests pass** across `test_movement_learning_readiness.py`,
  `test_movement_utility_iterated.py`, `test_movement_state.py` and
  `test_movement_learning.py` — the four suites that read the amended artefact or
  the amended modulator.
