...
|---|---|---|---|---|
| L4 | — | [§(g)](../../../docs/implementation/architecture.md) · [§(i)](../../../docs/implementation/architecture.md) | **stub** | **substrate seam — `mtdnetwork/` metrics** |
...
"Metrics pipeline" row; see [`docs/implementation/mtdsim_spec.md`](../../../docs/implementation/mtdsim_spec.md)
